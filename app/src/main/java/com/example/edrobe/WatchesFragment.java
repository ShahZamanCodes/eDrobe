...
public class WatchesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_watches, container, false);

        recyclerView = rootView.findViewById(R.id.itemsRecyclerView4);
        ...
        backButton = rootView.findViewById(R.id.watchesBackButton);
    ...
    private void EventChangeListner(){
        fstore.collection("watches").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override

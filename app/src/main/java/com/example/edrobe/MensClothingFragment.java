...
public class MensClothingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = rootView.findViewById(R.id.itemsRecyclerView);
        ...
        backButton = rootView.findViewById(R.id.mensBackButton);
    ...
    private void EventChangeListner(){
        fstore.collection("mensclothing").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override

...
public class KidsClothing extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_kids_clothing, container, false);

        recyclerView = rootView.findViewById(R.id.itemsRecyclerView2);
        ...
        backButton = rootView.findViewById(R.id.kidsBackButton);
    ...
    private void EventChangeListner(){
        fstore.collection("kidsclothing").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override

...
public class WomenClothingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_women_clothing, container, false);

        recyclerView = rootView.findViewById(R.id.itemsRecyclerView1);
        ...
        backButton = rootView.findViewById(R.id.womenBackButton);
    ...
    private void EventChangeListner(){
        fstore.collection("womensclothing").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
